                ...
                return h.createASCII = function(t, r) {
                    if ((t = t || 1) < 2) return function(t) {
                        ...
                        for (var r, e, n, o, i = +h.getModuleCount() + 2 * t, a = t, u = i - t, f = {
                            ...
                            for (e = Math.floor(g - a), n = Math.floor(g + 1 - a), r = 0; r < i; r += 1) o = "█", a <= r && r < u && a <= g && g < u && h.isDark(e, Math.floor(r - a)) && (o = " "), a <= r && r < u && a <= g + 1 && g + 1 < u && h.isDark(n, Math.floor(r - a)) ? o += " " : o += "█", c += t < 1 && u <= g + 1 ? l[o] : f[o];
                            c += "\n"
                        }
                        return i % 2 && 0 < t ? c.substring(0, c.length - i - 1) + Array(1 + i).join("▀") : c.substring(0, c.length - 1)
                    }(r);
                    --t, r = void 0 === r ? 2 * t : r;
                    for (var e, n, o, i = h.getModuleCount() * t + 2 * r, a = r, u = i - r, f = Array(t + 1).join("██"), l = Array(t + 1).join("  "), c = "", g = "", s = 0; s < i; s += 1) {
